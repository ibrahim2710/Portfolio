...
int main()
{
	...
	cin >> v;
	cout << "Enter the horizontal target distance in meters: ";
	cin >> Distance;
	cout << "Enter theta in degrees: ";
	cin >> theta;
	cout << "Enter the height of structure in meters: ";
	cin >> Height;
	phi = theta * (PI / 180);
	velocityX = v * cos(phi);
	velocityY = v * sin(phi);
	...
	cout << "The final velcoity is: "<<FinalBirdVelocity<<"m/s"<<endl;
	cout << "The time to reach strucutre is:" << t << "s" << endl;
	cout << "The dirrection is: " << Angle << "degrees" << endl;
	cout << "The height of the bird is: " << BirdHeight << "m" << endl;
